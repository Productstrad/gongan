...
<%@page import="java.util.Date"%><%@page import="service.LoginService"%><%@page import="vo.Medialib"%><%@page import="util.UploadFile"%><%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    String result=UploadFile.getInstance().uploadMedia(request, 0).replace(";", "");
    ...
    */
    //输出js    
	out.print("<script>try{parent.mediapath_set.value='"+result+"';}catch(e){};try{parent.mediapath.value='"+result+"';}catch(e){};parent.upMediaDialog.dialog('close');</script>");
%>