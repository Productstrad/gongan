...
<body>
<form id="picForm" action='/common/pic/uploadpic.jsp' method='post' enctype='multipart/form-data'>
	<table align="center" border="0" style="padding-top:15px;">
		...
		<tr><td colspan="2" align="center"><a class="btn" href="javascript:document.getElementById('picForm').submit();" >上传</a></td></tr>
	</table>
</form>
</body>
</html>