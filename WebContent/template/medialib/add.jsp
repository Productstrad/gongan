...
<table align="center" border="0" style="padding-top:15px;">	
	...
	<tr><td>mediaTitle:</td><td><input name="mediaTitle" id="mediaTitle" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>mediaPath:</td><td><input name="mediaPath" id="mediaPath" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>1图片:</td><td><input name="mediaType" id="mediaType" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>传图者账号id:</td><td><input name="userid" id="userid" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>传图者账号id:</td><td><input name="createDate" id="createDate" type="text" size="60" maxlength="50" /></td></tr>
