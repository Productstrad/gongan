...
function add(){	
	$("<div><iframe id='dialogIframe' src='add.do' width='500px' height='150px' style='border:none;' frameborder='0'></iframe></div>").dialog({ autoOpen: true, modal: true, title: "添加" });	
}
function edit(id){	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="listtable">
  <tr class="tth">
    <td>id</td><td>调查名称</td><td>调查发布人</td><td>调查开始时间</td><td>调查结束时间</td>     
    <td >操作</td>  
  </tr>
  <c:forEach items="${list}" var="vo" varStatus="i">
	<c:choose>
		...
		<td align="center">
		<a href="/sys/surveyquestion/list.do?surveyId=${vo.id }">问题管理</a>&nbsp;
