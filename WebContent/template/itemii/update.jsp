...
<tr><td>二级栏目id:</td><td><label>${vo.id }</label></td></tr>
<tr><td>二级栏目名称:</td><td><input name="itemIIname_set" id="itemIIname_set" type="text" size="60" maxlength="50" value="${vo.itemIIname }"/></td></tr>
