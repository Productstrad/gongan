...
<tr><td>会员微信号:</td><td><input name="weixincode_set" id="weixincode_set" type="text" size="60" maxlength="50" value="${vo.weixincode }"/></td></tr>
<tr><td>关注时间:</td><td><input name="focusTime_set" id="focusTime_set" type="text" size="60" maxlength="50" value="${vo.focusTime }"/></td></tr>
<tr><td>最后访问时间:</td><td><input name="lastaccesstime_set" id="lastaccesstime_set" type="text" size="60" maxlength="50" value="${vo.lastaccesstime }"/></td></tr>
