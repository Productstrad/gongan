...
<table align="center" border="0" style="padding-top:15px;">	
	...
	<tr><td>会员微信号:</td><td><input name="weixincode" id="weixincode" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>关注时间:</td><td><input name="focusTime" id="focusTime" type="text" size="60" maxlength="50" /></td></tr>
	<tr><td>最后访问时间:</td><td><input name="lastaccesstime" id="lastaccesstime" type="text" size="60" maxlength="50" /></td></tr>
