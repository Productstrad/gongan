...
<tr><td>栏目id:</td><td><label>${vo.id }</label></td></tr>
<tr><td>栏目名称:</td><td><input name="itemIname_set" id="itemIname_set" type="text" size="60" maxlength="50" value="${vo.itemIname }"/></td></tr>
